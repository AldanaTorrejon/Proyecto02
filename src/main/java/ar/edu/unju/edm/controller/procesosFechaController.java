...
public class procesosFechaController {
	...
	public ModelAndView getProcesoFecha() {
		...
		ProcesosFecha pf1 = new ProcesosFecha(LocalDate.of(2000, 4, 15), LocalDate.now());
	...
	public ModelAndView getProcesoFecha2() {
		...
		ProcesosFecha pf2 = new ProcesosFecha(LocalTime.of(5, 30, 2), LocalTime.of(20, 40, 10));
	...
	public ModelAndView getProcesoFecha4() {
		...
		ProcesosFecha pf3 = new ProcesosFecha(LocalDateTime.of(2003, 7, 26, 12, 53, 10),
	...
	public ModelAndView getProcesoFecha5() {
		...
		ProcesosFecha pf4 = new ProcesosFecha(LocalDate.of(2003, 7, 26), LocalDate.now());
	...
	public ModelAndView getProcesoFecha6(@RequestParam(name = "fecha1") String fecha1, @RequestParam(name = "fecha2") String fecha2) throws DateTimeException {
		...
		try {
			...
			throw new DateTimeException("Debe ingresar una fecha");
		}
	}
}
